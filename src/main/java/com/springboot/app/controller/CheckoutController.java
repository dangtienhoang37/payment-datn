...
public class CheckoutController {
    ...
    public void checkout(HttpServletRequest request, HttpServletResponse httpServletResponse) {
        try {
            ...
            // them logic tao 1 transaction chuyen vao redis
    ...
    @RequestMapping(method = RequestMethod.POST, value = "/create-payment-link1", consumes = MediaType.APPLICATION_FORM_URLENCODED_VALUE)
    public ResponseEntity checkout1(HttpServletRequest request, HttpServletResponse httpServletResponse) {
        try {
            final String baseUrl = getBaseUrl(request);
            final String productName = "Mì tôm hảo hảo ly";
            final String description = "Thanh toan don hang";
